<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
                ...
                <div class="box box-widget widget-user-2">
                    <div class="widget-user-header bg-blue">
                        <a data-toggle="modal" href="#up_info<?php echo $user->id; ?>" >
                            <i class="fa fa-pencil-square-o" style="float:right; color:#fff;" data-toggle="tooltip" data-placement="left" title="Upadte information" data-original-title="Upadte information"></i>
                        </a>
                        <a data-toggle="modal" href="#up_img<?php echo $user->id; ?>">
                            <i class="fa fa-picture-o" style="float:right; color:#fff;  margin-right: 8px;" data-toggle="tooltip" data-placement="left" title="Update Profile Image" data-original-title="Update Profile Image"></i>
                        </a>
                        <a data-toggle="modal" href="#pass<?php echo $user->id; ?>">
                            <i class="fa fa-lock" style="float:right; color:#fff;  margin-right: 8px;" data-toggle="tooltip" data-placement="left" title="Update Password" data-original-title="Update Password"></i>
                        </a>
                        <div class="widget-user-image">
                            <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url(); ?>uploads/admin/img/profile/<?php echo $user->avatar; ?>" alt="<?php echo $user->avatar; ?>">
                        </div>
            ...
            <div class="modal fade" id="up_info<?php echo $user->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <?php echo form_open(site_url("my_profile/update_info")); ?>
            ...
            <div class="modal fade" id="up_img<?php echo $user->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <?php echo form_open_multipart(site_url("my_profile/update_image")); ?>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
            ...
            <!-- update pass modal -->
            <div class="modal fade" id="pass<?php echo $user->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        ...
                        <?php echo form_open(site_url("my_profile/pro_update_pass")); ?>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <label for="input_old_password">Old Password<sup>*</sup></label>
                                            <input class="form-control" id="input_old_password" type="password" value="" placeholder="Old Password" name="old_pass" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <label for="input_new_password">New Password<sup>*</sup></label>
                                            <input class="form-control" id="input_new_password" type="password" value="" placeholder="New Password" name="new_pass" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <label for="input_con_password">Confirm New Password<sup>*</sup></label>
                                            <input class="form-control" id="input_con_password" type="password" value="" placeholder="Confirm New Password" name="con_pass" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
